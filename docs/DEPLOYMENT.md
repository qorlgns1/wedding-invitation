...
- (optional) `VITE_COVER_IMAGE_URL`, `VITE_CALENDAR_IMAGE_URL`, `VITE_VENUE_MAP_IMAGE_URL`, `VITE_INTRO_IMAGE_URL`, `VITE_GALLERY_URLS` — only needed if you replace local images with links from a host like [ImgBB](https://imgbb.com). See [`README.md`](../README.md#adding-gallery-photos) for details.
