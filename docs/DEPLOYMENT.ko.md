...
- (선택) `VITE_COVER_IMAGE_URL`, `VITE_CALENDAR_IMAGE_URL`, `VITE_VENUE_MAP_IMAGE_URL`, `VITE_INTRO_IMAGE_URL`, `VITE_GALLERY_URLS` — [ImgBB](https://imgbb.com) 등에 올린 이미지 링크로 로컬 이미지를 대체할 때만 설정. 자세한 내용은 [`README.md`](../README.md#갤러리-사진-추가) 참고
